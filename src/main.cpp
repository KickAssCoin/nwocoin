...
uint256 hashGenesisBlock("0x0a33888efa07b5ab764d9b95bc8cb127f1a72e69ba6cecac9f5e825b8e1c7f6c");
...
{
    int64 nSubsidy = 10 * COIN; // NWOcoin: 100 (Litecoin: 50) 10 for KAC

    // Subsidy is cut in half every 800000 blocks
    nSubsidy >>= (nHeight / 100000); // NWOcoin: 800k blocks in ~1 years  100k for KAC

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan_Version1 = 60 * 10; // NWOcoin: 60 minutes (Litecoin: 3.5 days) 10 minute for KAC
static const int64 nTargetSpacing = 30; // NWOcoin: 40 seconds (~1/4x Litecoin: 2.5 minutes) 30 sec for KAC
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0a33888efa07b5ab764d9b95bc8cb127f1a72e69ba6cecac9f5e825b8e1c7f6c");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "switz turns godly";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        txNew.strTxComment = "text:switz genesis block";
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1388291973;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1001215076;
        ...
        assert(block.hashMerkleRoot == uint256("0x826f6f2a3004bc4720a3cf6cc9a261aa5f041febb2400b0b75264e82a58ddaae"));
